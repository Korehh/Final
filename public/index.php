...
// GET REQUEST
$app->get('/employ', function (Request $request, Response $response, array $args) {
    $db = new DB();
...
$app->get('/employ/{id}', function (Request $request, Response $response, array $args) {
    $id = $args['id'];
    $db = new DB();
...
$app->post('/employ/add', function (Request $request, Response $response, array $args) {
...
$app->put('/employ/update/{id}', function (Request $request, Response $response, array $args) {
...
$app->delete('/employ/delete/{id}', function (Request $request, Response $response, array $args) {
    $sql = null;
